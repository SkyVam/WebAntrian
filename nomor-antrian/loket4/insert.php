...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) {
  ...
  $query = mysqli_query($mysqli, "SELECT max(no_antrian) as nomor FROM tbl_antrian4 WHERE tanggal='$tanggal'")
  ...
  $insert = mysqli_query($mysqli, "INSERT INTO tbl_antrian4(tanggal, no_antrian) 
